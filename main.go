...
func main() {
	...
	// createPng()
	// base64toPng()
	base64toJpg(getJPEGbase64("2c0bf8f649e85247458038e2a09bda60.jpeg"))
}

//Take an existing jpg srcFileName and decode/encode it
func createJpg() {

	srcFileName := "Clock_Tower_-_Palace_of_Westminster,_London_-_May_2007.jpg"
...
func base64toJpg(data string) {
	...
	err = jpeg.Encode(f, m, &jpeg.Options{Quality: 20})
	if err != nil {
		log.Fatal(err)
		return
	}
